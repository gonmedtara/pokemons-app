...
var Store = (function () {
    ...
    Store.prototype.init = function () {
        ...
        return node.open('restRequest', 1, function (upgradeDb) {
            ...
            return _this.db = database;
        });
    };
    Store.prototype.requests = function (mode) {
        var _this = this;
        return this.init().then(function (db) {
            return _this.db.transaction('requests', mode).objectStore('requests');
        });
    };
    Store.prototype.responses = function (mode) {
        var _this = this;
        return this.init().then(function (db) {
            return _this.db.transaction('responses', mode).objectStore('responses');
        });
    };
    Store.prototype.closeTransaction = function () {
